...
RSpec.describe "/products", type: :request do
  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      xit "renders a JSON response with the new product" do
        post products_url,
             params: { product: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      xit "renders a JSON response with errors for the new product" do
        post products_url,
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      xit "renders a JSON response with the product" do
        product = Product.create! valid_attributes
        patch product_url(product),
              params: { product: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      xit "renders a JSON response with errors for the product" do
        product = Product.create! valid_attributes
        patch product_url(product),
              params: { product: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
